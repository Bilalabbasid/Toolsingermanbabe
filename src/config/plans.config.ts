...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    features: [
      ...
      { text: 'Prioritäre Konvertierung ohne Wartezeit', included: false },
      { text: 'Gespeicherter Konvertierungsverlauf', included: false },
    ],
    limits: {
      maxFileSizeMB: 50,
      batchLimit: 5,
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Prioritäre Konvertierung (bevorzugte Warteschlange)', included: true },
      { text: 'Unbegrenzte Hochpräzisions-OCR', included: true },
      { text: 'Konvertierungsverlauf für 30 Tage gespeichert', included: true },
      { text: '1-Klick-Sammeldownload als ZIP-Archiv', included: true },
  ...
  },
  {
    ...
    features: [
      { text: 'Alle Pro-Funktionen für bis zu 10 Benutzer', included: true },
      ...
      { text: 'SLA-Garantie & bevorzugter 24/7-Support', included: true },
    ],
    limits: {
      maxFileSizeMB: 2048,
      batchLimit: 250,
