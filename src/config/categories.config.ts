...
export const CATEGORIES: Record<ToolCategory, CategoryInfo> = {
  pdf: {
    ...
    icon: 'FileText',
    metaTitle: 'PDF-Tools kostenlos online – Bearbeiten & Konvertieren | CoolWave',
  ...
  documents: {
    ...
    metaDescription: 'Dokumente schnell online konvertieren. Word in PDF, PDF in Word, Excel- und Textdateien sicher im Webbrowser transformieren.',
    h1: 'Dokumente und Office-Dateien konvertieren',
  },
  utilities: {
    slug: 'utilities',
    name: 'Text-Tools & Hilfsmittel',
    shortDesc: 'Wortzähler, Zeichenzähler, JSON-Formatierer und nützliche Hilfsprogramme.',
    icon: 'Wrench',
    metaTitle: 'Text-Tools & Entwickler-Hilfsmittel online | CoolWave',
    metaDescription: 'Kostenlose Web-Hilfsmittel: Wortzähler, Zeichenzähler, JSON-Formatierer, Base64-Codierer und nützliche Text-Werkzeuge.',
  ...
  security: {
    ...
    icon: 'Shield',
    metaTitle: 'PDF-Sicherheit online – Dokumente schützen & sperren | CoolWave',
  ...
  ocr: {
    ...
    icon: 'ScanText',
    metaTitle: 'OCR Texterkennung online – PDF & Bild zu Text | CoolWave',
