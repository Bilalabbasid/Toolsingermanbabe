...
import { Mail, MessageSquare, Clock, ShieldCheck, Send, CheckCircle2, AlertCircle } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 bg-slate-50/50"
                >
                  <option value="support">Hilfe bei einer Konvertierung / Tool-Support</option>
                  <option value="billing">Fragen zu CoolWave Pro / Rechnung</option>
                  <option value="feature">Feedback & Vorschlag für neues Tool</option>
