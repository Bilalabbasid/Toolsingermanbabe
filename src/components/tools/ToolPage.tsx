    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-slate-100 border border-slate-200 text-slate-700 text-xs font-semibold">
              {tool.browserCapable ? (
                <>
                  ...
                  <span>Lokale Browser-Verarbeitung (100% Datenschutz)</span>
                </>
              ) : (
                <>
                  <ShieldCheck className="w-3.5 h-3.5 text-indigo-600" />
                  <span>Verschlüsselte Cloud-Verarbeitung (15 Min. Auto-Löschung)</span>
                </>
              )}
            </div>
          </div>
        ...
        <section className="my-16 max-w-4xl mx-auto">
          <div className="p-8 sm:p-10 rounded-2xl bg-white border border-slate-200/80 shadow-sm">
            ...
            {tool.privacyExplanationDe && (
              <div className="mt-8 pt-6 border-t border-slate-100">
                <div className="flex items-start gap-3 p-4 rounded-xl bg-slate-50/80 border border-slate-200">
